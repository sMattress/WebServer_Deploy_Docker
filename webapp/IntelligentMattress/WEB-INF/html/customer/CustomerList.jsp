					...
					<ul class="pager">
						<c:choose>
							<c:when test="${page.pageNo>1}">
								<li><a
									href="<%=basePath%>customer/customersList?pageNo=${page.pageNo-1}">&larr;
										上一页</a>
								<li>
							</c:when>
							<c:otherwise>
						...
						<c:choose>
							<c:when test="${page.pageNo < page.totalPages}">
								<li><a
									href="<%=basePath%>customer/customersList?pageNo=${page.pageNo+1}">下一页
										&rarr;</a>
								<li>
							</c:when>
							<c:otherwise>
