...
function notify_setDefaultValues() {
	// Default size
	width = 400;
	height = 60;
	// Default position
...
function notify(config) {
	...
	notify_setDefaultValues();

	if (config.position) {
		if (config.position == "center" || config.position == "left"
	...
	var div = "<div id='ui_notifIt'><p>" + ((config.msg) ? config.msg : "")
			+ "</p></div>";
